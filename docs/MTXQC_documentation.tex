...
\chapter{Content of MTXQCvX documentation}\label{intro}
...
pulsed stable isotope resolved metabolomics (pSIRM) approach published
in \citep{Pietzke2014}.
...
\begin{tabu} to \linewidth {>{\raggedright}X>{\raggedright}X>{\raggedright}X>{\raggedright}X>{\raggedright}X>{\raggedleft}X>{\raggedright}X>{\raggedright}X>{\raggedright}X>{\raggedright}X}
\hiderowcolors
\toprule
